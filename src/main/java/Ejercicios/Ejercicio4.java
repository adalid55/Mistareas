...
public class Ejercicio4 {
   ...
   if(isWin(1))
   throw new IllegalArgumentException("Player 1 has already won"); // Verificas si el jugador 1 ya ganó
   if(isWin(-1))
   throw new IllegalArgumentException("Player 2 has already won"); // Verificas si el jugador 2 ya ganó
   ...
   Ejercicio4 game = new Ejercicio4( );
   /* X moves: */ /* O moves: */
